...
import { buildIconUrl } from '../utils/build-icon-url.mjs';

/** Map of AG Grid icon names to their corresponding PDS icons */
const agGridToPdsIconMap = {
...
const pdsSvgIcons = iconOverrides({
    ...
    mask: true,
    icons: {
        ...Object.fromEntries(Object.entries(agGridToPdsIconMap).map(([key, value]) => [key, { url: buildIconUrl(value) }])),
    },
});
