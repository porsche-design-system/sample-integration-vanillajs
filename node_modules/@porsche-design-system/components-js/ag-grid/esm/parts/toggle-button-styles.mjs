...
import { borderWidthBase, spacingStaticXSmall, themeLightBackgroundBase, themeDarkStateDisabled, themeDarkContrastMedium, themeDarkPrimary, themeDarkSuccessColorDarken, themeDarkNotificationSuccess, themeDarkBackgroundBase, themeLightStateDisabled, themeLightContrastMedium, themeLightPrimary, themeLightSuccessColorDarken, themeLightNotificationSuccess } from '../styles.mjs';
