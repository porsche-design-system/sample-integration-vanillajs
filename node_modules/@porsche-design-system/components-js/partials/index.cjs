...
function getFontFaceStylesheet(opts) {
    ...
    const url = `${cdnBaseUrl}/porsche-design-system/styles/${cdn === 'cn'
        ? 'font-face.cn.5ef46c7.css'
        : 'font-face.e121b81.css'}`;
    return format === 'html'
        ...
        : jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx("link", { rel: "preconnect", href: cdnBaseUrl, crossOrigin: "" }), jsxRuntime.jsx("link", { rel: "dns-prefetch", href: cdnBaseUrl, crossOrigin: "" }), jsxRuntime.jsx("link", { rel: "stylesheet", href: url, type: "text/css", crossOrigin: "" })] });
}
...
function getInitialStyles(opts) {
    ...
    const tagNames = ['p-accordion', 'p-banner', 'p-button', 'p-button-group', 'p-button-pure', 'p-button-tile', 'p-canvas', 'p-carousel', 'p-checkbox', 'p-checkbox-wrapper', 'p-content-wrapper', 'p-crest', 'p-display', 'p-divider', 'p-fieldset', 'p-fieldset-wrapper', 'p-flex', 'p-flex-item', 'p-flyout', 'p-flyout-multilevel', 'p-flyout-multilevel-item', 'p-grid', 'p-grid-item', 'p-heading', 'p-headline', 'p-icon', 'p-inline-notification', 'p-link', 'p-link-pure', 'p-link-social', 'p-link-tile', 'p-link-tile-model-signature', 'p-link-tile-product', 'p-marque', 'p-modal', 'p-model-signature', 'p-multi-select', 'p-multi-select-option', 'p-optgroup', 'p-pagination', 'p-pin-code', 'p-popover', 'p-radio-button-wrapper', 'p-scroller', 'p-segmented-control', 'p-segmented-control-item', 'p-select', 'p-select-option', 'p-select-wrapper', 'p-spinner', 'p-stepper-horizontal', 'p-stepper-horizontal-item', 'p-switch', 'p-table', 'p-table-body', 'p-table-cell', 'p-table-head', 'p-table-head-cell', 'p-table-head-row', 'p-table-row', 'p-tabs', 'p-tabs-bar', 'p-tabs-item', 'p-tag', 'p-tag-dismissible', 'p-text', 'p-text-field-wrapper', 'p-text-list', 'p-text-list-item', 'p-textarea', 'p-textarea-wrapper', 'p-toast', 'p-wordmark'];
...
Please use only valid font weights:
  ${supportedWeights.join(', ')}`);
    ...
    if (format === 'html') {
        ...
        const linksJsx = urls.map((url, index) => jsxRuntime.jsx("link", { rel: "preload", href: url, as: "font", type: "font/woff2", crossOrigin: "" }, index));
...
Please use only valid component chunk names:
  ${supportedComponentChunkNames.join(', ')}`);
    ...
    const cdnBaseUrl = getCdnBaseUrl(cdn);
    const manifest = { "core": "porsche-design-system.v3.24.0.c01565aed778dac3ba5b.js", "accordion": "porsche-design-system.accordion.38143f318e62d564f08c.js", "banner": "porsche-design-system.banner.5d70ea6bbf09ba16e673.js", "button-group": "porsche-design-system.button-group.d87a7a8d7962b06a60a9.js", "button-pure": "porsche-design-system.button-pure.19c6c86344062b0f0ebd.js", "button-tile": "porsche-design-system.button-tile.674518ed298112ccae5b.js", "button": "porsche-design-system.button.66e460b140d9ae991c14.js", "canvas": "porsche-design-system.canvas.012a5574b3dfb98ca13b.js", "carousel": "porsche-design-system.carousel.05e263c7320ea99554cc.js", "checkbox-wrapper": "porsche-design-system.checkbox-wrapper.04938ca9857ffec51250.js", "checkbox": "porsche-design-system.checkbox.534e8acd8b6cd7d5d634.js", "content-wrapper": "porsche-design-system.content-wrapper.09e408c2f1663978f3c2.js", "crest": "porsche-design-system.crest.db62cf5c955b13a96a4d.js", "display": "porsche-design-system.display.18b2ff1d6b62b54b1c6e.js", "divider": "porsche-design-system.divider.6536fc15538fc53c501c.js", "fieldset-wrapper": "porsche-design-system.fieldset-wrapper.f11e5f3fbda4063c15da.js", "fieldset": "porsche-design-system.fieldset.8709c1a6a6f7592b6912.js", "flex": "porsche-design-system.flex.523baad36b113945599f.js", "flyout-multilevel": "porsche-design-system.flyout-multilevel.bb181110c1b82c95b49b.js", "flyout": "porsche-design-system.flyout.d2c910ebc52a2556f964.js", "grid": "porsche-design-system.grid.d02f0f8c6075382fd79f.js", "heading": "porsche-design-system.heading.eb69c8d1d2e48af70617.js", "headline": "porsche-design-system.headline.4bb2d04ad0127915de96.js", "icon": "porsche-design-system.icon.a8ff18a42007945651b6.js", "inline-notification": "porsche-design-system.inline-notification.538c3fab8fa439ccf2b1.js", "link-pure": "porsche-design-system.link-pure.a0a1255a7ffc15cc8699.js", "link-social": "porsche-design-system.link-social.e983ea352015b5ec37c2.js", "link-tile-model-signature": "porsche-design-system.link-tile-model-signature.13d790fe302f9d515cdb.js", "link-tile-product": "porsche-design-system.link-tile-product.76d3c588e21dae5e2a9f.js", "link-tile": "porsche-design-system.link-tile.ab91110f6f3b1b47b964.js", "link": "porsche-design-system.link.489da838ef61993d5d2b.js", "marque": "porsche-design-system.marque.f7b64bd163ffc4663359.js", "modal": "porsche-design-system.modal.38b6fe7f4f6a02f9fc02.js", "model-signature": "porsche-design-system.model-signature.373a57665461dfeda95e.js", "multi-select": "porsche-design-system.multi-select.1bbd93342720385f47df.js", "optgroup": "porsche-design-system.optgroup.de990821eeb905c3ebce.js", "pagination": "porsche-design-system.pagination.f5a840171329928e56b1.js", "pin-code": "porsche-design-system.pin-code.f4c22b0804c1294f4833.js", "popover": "porsche-design-system.popover.dc0ba891dbc2fc83ea36.js", "radio-button-wrapper": "porsche-design-system.radio-button-wrapper.96476ead86edf49c22f4.js", "scroller": "porsche-design-system.scroller.f7d18707f61679eb2922.js", "segmented-control": "porsche-design-system.segmented-control.4a17f2138a04dc940f28.js", "select-wrapper": "porsche-design-system.select-wrapper.0dc63712403ca8d88f25.js", "select": "porsche-design-system.select.a8774754a2a179e4e427.js", "spinner": "porsche-design-system.spinner.78355db4797dfadf899b.js", "stepper-horizontal": "porsche-design-system.stepper-horizontal.023d91c7d6cb9b3cfaa5.js", "switch": "porsche-design-system.switch.559be2367b884c932327.js", "table": "porsche-design-system.table.81c31518f19118c417db.js", "tabs-bar": "porsche-design-system.tabs-bar.c9f2b1989f19bfbed74b.js", "tabs": "porsche-design-system.tabs.61d050647d46f68433bd.js", "tag-dismissible": "porsche-design-system.tag-dismissible.f84b3579bed5f714ee0f.js", "tag": "porsche-design-system.tag.6ce87c1c849336af4d62.js", "text-field-wrapper": "porsche-design-system.text-field-wrapper.3b02a77870fb84e309df.js", "text-list": "porsche-design-system.text-list.dfc98a57d599a540f124.js", "text": "porsche-design-system.text.f470cdbfb78ea26fd0a9.js", "textarea-wrapper": "porsche-design-system.textarea-wrapper.32808142cf0b837c50a1.js", "textarea": "porsche-design-system.textarea.baf49b052fb3ca77c377.js", "toast": "porsche-design-system.toast.f998d7e1f254c8ede0ac.js", "wordmark": "porsche-design-system.wordmark.355ba7670ee5a90884d0.js" };
...
function getMetaTagsAndIconLinks(opts) {
    ...
    const cdnBaseUrl = getCdnBaseUrl(cdn);
    const manifestUrlCom = 'https://cdn.ui.porsche.com/porsche-design-system/meta-icons/manifest.b904b15.webmanifest';
    const manifestUrlCn = 'https://cdn.ui.porsche.cn/porsche-design-system/meta-icons/manifest.cn.7d59be6.webmanifest';
    ...
    if (format === 'html') {
        ...
        let metaIconTagsJSX = [jsxRuntime.jsx("meta", { name: "theme-color", content: "#FFF", media: "(prefers-color-scheme:light)" }), jsxRuntime.jsx("meta", { name: "theme-color", content: "#0E1418", media: "(prefers-color-scheme:dark)" }), jsxRuntime.jsx("meta", { name: "mobile-web-app-capable", content: "yes" }), jsxRuntime.jsx("meta", { name: "apple-mobile-web-app-status-bar-style", content: "default" }), jsxRuntime.jsx("meta", { name: "apple-mobile-web-app-title", content: appTitle }), jsxRuntime.jsx("meta", { name: "msapplication-TileImage", content: `${cdnBaseUrl}/porsche-design-system/meta-icons/mstile-270x270.f58081f.png` }), jsxRuntime.jsx("meta", { name: "msapplication-TileColor", content: "#FFF" }), jsxRuntime.jsx("link", { rel: "icon", sizes: "any", href: `${cdnBaseUrl}/porsche-design-system/meta-icons/favicon.ed9a926.ico` }), jsxRuntime.jsx("link", { rel: "icon", type: "image/png", sizes: "32x32", href: `${cdnBaseUrl}/porsche-design-system/meta-icons/favicon-32x32.d42ac28.png` }), jsxRuntime.jsx("link", { rel: "apple-touch-icon", href: `${cdnBaseUrl}/porsche-design-system/meta-icons/apple-touch-icon-180x180.bdf11cc.png` }), jsxRuntime.jsx("link", { rel: "manifest", href: manifestUrl })];
        if (ogImage) {
            metaIconTagsJSX = [jsxRuntime.jsx("meta", { property: "og:title", content: appTitle }), jsxRuntime.jsx("meta", { property: "og:image", content: `${cdnBaseUrl}/porsche-design-system/meta-icons/og-image.c880d39.png` }), jsxRuntime.jsx("meta", { name: "twitter:title", content: appTitle }), jsxRuntime.jsx("meta", { name: "twitter:card", content: "summary_large_image" }), jsxRuntime.jsx("meta", { name: "twitter:image", content: `${cdnBaseUrl}/porsche-design-system/meta-icons/og-image.c880d39.png` })].concat(metaIconTagsJSX);
        }
...
function getIconLinks(opts) {
    ...
    const supportedIconNames = ["360", "accessibility", "active-cabin-ventilation", "add", "adjust", "arrow-double-down", "arrow-double-left", "arrow-double-right", "arrow-double-up", "arrow-down", "arrow-first", "arrow-head-down", "arrow-head-left", "arrow-head-right", "arrow-head-up", "arrow-last", "arrow-left", "arrow-right", "arrow-up", "attachment", "augmented-reality", "battery-empty", "battery-empty-co2", "battery-empty-fuel", "battery-full", "bell", "bookmark", "bookmark-filled", "broadcast", "calculator", "calendar", "camera", "car", "car-battery", "card", "charging-active", "charging-state", "charging-station", "chart", "chat", "check", "city", "climate", "climate-control", "clock", "close", "closed-caption", "co2-class", "co2-emission", "compare", "configurate", "copy", "country-road", "cubic-capacity", "delete", "disable", "dislike", "dislike-filled", "document", "download", "duration", "edit", "email", "error-filled", "exclamation", "external", "filter", "fingerprint", "flash", "fuel-station", "garage", "gift", "globe", "grid", "heart", "heart-filled", "highway", "home", "horn", "image", "increase", "information", "information-filled", "key", "leaf", "leather", "light", "like", "like-filled", "list", "locate", "lock", "lock-open", "logo-apple-podcast", "logo-baidu", "logo-delicious", "logo-digg", "logo-facebook", "logo-foursquare", "logo-gmail", "logo-google", "logo-hatena", "logo-instagram", "logo-kaixin", "logo-kakaotalk", "logo-linkedin", "logo-naver", "logo-pinterest", "logo-qq", "logo-qq-share", "logo-reddit", "logo-skyrock", "logo-sohu", "logo-spotify", "logo-tecent", "logo-telegram", "logo-tiktok", "logo-tumblr", "logo-twitter", "logo-viber", "logo-vk", "logo-wechat", "logo-weibo", "logo-whatsapp", "logo-x", "logo-xing", "logo-yahoo", "logo-youku", "logo-youtube", "logout", "map", "menu-dots-horizontal", "menu-dots-vertical", "menu-lines", "minus", "mobile", "moon", "new-chat", "oil-can", "parking-brake", "parking-light", "pause", "phone", "pin", "pin-filled", "play", "plug", "plus", "preheating", "printer", "purchase", "push-pin", "push-pin-off", "qr", "question", "racing-flag", "refresh", "replay", "reset", "roof-closed", "roof-open", "route", "rss", "save", "screen", "search", "send", "share", "shopping-bag", "shopping-bag-filled", "shopping-cart", "shopping-cart-filled", "sidebar", "sidelights", "snowflake", "sort", "stack", "star", "star-filled", "steering-wheel", "stopwatch", "subtract", "success", "success-filled", "sun", "switch", "tablet", "tachometer", "tire", "truck", "upload", "user", "user-filled", "user-group", "user-manual", "video", "view", "view-off", "volume-off", "volume-up", "warning", "warning-filled", "weight", "wifi", "work", "wrench", "wrenches", "zoom-in", "zoom-out"];
...
function getLoaderScript(opts) {
    ...
    return format === 'sha256'
        ...
        : format === 'html'
            ...
            : jsxRuntime.jsx("script", { ...scriptProps, dangerouslySetInnerHTML: { __html: scriptContent } });
}
function getBrowserSupportFallbackScript(opts) {
    ...
    const cdnBaseUrl = getCdnBaseUrl(cdn);
    const scriptContent = `!function(){if(["IntersectionObserver","MutationObserver","customElements"].some((e=>!(e in window)))){const e=document.createElement("script");e.src="${cdnBaseUrl}/porsche-design-system/fallbacks/browser-support.1a10176.js",document.body.appendChild(e)}}();`;
    // there is no other solution than using dangerouslySetInnerHTML since JSX elements are rendered by the createElement() function
    // https://stackoverflow.com/a/64815699
    return format === 'sha256'
        ? getSha256Hash(scriptContent)
        : format === 'html'
            ...
            : jsxRuntime.jsx("script", { dangerouslySetInnerHTML: { __html: scriptContent } });
}
function getCookiesFallbackScript(opts) {
    ...
    const cdnBaseUrl = getCdnBaseUrl(cdn);
    const scriptContent = `!function(){if(!(window.navigator||navigator).cookieEnabled){const o=document.createElement("script");o.src="${cdnBaseUrl}/porsche-design-system/fallbacks/cookies.a9ad23a.js",document.body.appendChild(o)}}();`;
    // there is no other solution than using dangerouslySetInnerHTML since JSX elements are rendered by the createElement() function
    // https://stackoverflow.com/a/64815699
    return format === 'sha256'
        ? getSha256Hash(scriptContent)
