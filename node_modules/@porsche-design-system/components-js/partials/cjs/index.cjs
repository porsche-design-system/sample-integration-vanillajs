...
function getFontFaceStylesheet(opts) {
    ...
    const url = `${cdnBaseUrl}/porsche-design-system/styles/${cdn === 'cn'
        ? 'font-face.cn.c531632.css'
        : 'font-face.7076ba0.css'}`;
    return format === 'html'
...
function getInitialStyles(opts) {
    ...
    const tagNames = ['p-accordion', 'p-banner', 'p-button', 'p-button-group', 'p-button-pure', 'p-button-tile', 'p-canvas', 'p-carousel', 'p-checkbox', 'p-checkbox-wrapper', 'p-content-wrapper', 'p-crest', 'p-display', 'p-divider', 'p-drilldown', 'p-drilldown-item', 'p-drilldown-link', 'p-fieldset', 'p-fieldset-wrapper', 'p-flag', 'p-flex', 'p-flex-item', 'p-flyout', 'p-grid', 'p-grid-item', 'p-heading', 'p-headline', 'p-icon', 'p-inline-notification', 'p-input-date', 'p-input-email', 'p-input-number', 'p-input-password', 'p-input-search', 'p-input-tel', 'p-input-text', 'p-input-time', 'p-input-url', 'p-link', 'p-link-pure', 'p-link-social', 'p-link-tile', 'p-link-tile-model-signature', 'p-link-tile-product', 'p-marque', 'p-modal', 'p-model-signature', 'p-multi-select', 'p-multi-select-option', 'p-optgroup', 'p-pagination', 'p-pin-code', 'p-popover', 'p-radio-button-wrapper', 'p-scroller', 'p-segmented-control', 'p-segmented-control-item', 'p-select', 'p-select-option', 'p-select-wrapper', 'p-sheet', 'p-spinner', 'p-stepper-horizontal', 'p-stepper-horizontal-item', 'p-switch', 'p-table', 'p-table-body', 'p-table-cell', 'p-table-head', 'p-table-head-cell', 'p-table-head-row', 'p-table-row', 'p-tabs', 'p-tabs-bar', 'p-tabs-item', 'p-tag', 'p-tag-dismissible', 'p-text', 'p-text-field-wrapper', 'p-text-list', 'p-text-list-item', 'p-textarea', 'p-textarea-wrapper', 'p-toast', 'p-wordmark'];
    ...
    const styleAttributes = convertPropsToAttributeString(styleProps);
    const normalizeStyles = `html,body{margin:0;padding:0;font-family:'Porsche Next','Arial Narrow',Arial,'Heiti SC',SimHei,sans-serif;line-height:calc(6px + 2.125ex);letter-spacing:normal;text-size-adjust:none;-webkit-text-size-adjust:none}`;
...
Please use only valid component chunk names:
  ${supportedComponentChunkNames.join(', ')}`);
    ...
    const cdnBaseUrl = getCdnBaseUrl(cdn);
    const manifest = { "core": "porsche-design-system.v3.29.0.c747d4e24a1fc76fef40.js", "accordion": "porsche-design-system.accordion.81cebd232120ce5d3711.js", "banner": "porsche-design-system.banner.11c2b350c0817670e223.js", "button-group": "porsche-design-system.button-group.cccef02eeb2e46b19109.js", "button-pure": "porsche-design-system.button-pure.53d2685dd267d0961556.js", "button-tile": "porsche-design-system.button-tile.58c71045d676ce07ebd5.js", "button": "porsche-design-system.button.cdd27f05fe342e6e79d3.js", "canvas": "porsche-design-system.canvas.ae05ec5e10a96795d5a8.js", "carousel": "porsche-design-system.carousel.20cd734827a2a198e0ec.js", "checkbox-wrapper": "porsche-design-system.checkbox-wrapper.09567b795abb4f1faef8.js", "checkbox": "porsche-design-system.checkbox.ed291f1c72821b969d04.js", "content-wrapper": "porsche-design-system.content-wrapper.36ab912ed663dde02085.js", "crest": "porsche-design-system.crest.fdd4d73404990ad174b2.js", "display": "porsche-design-system.display.bf321065df1113959def.js", "divider": "porsche-design-system.divider.befa4ba806f29c9ad6da.js", "drilldown": "porsche-design-system.drilldown.2a1f0950ad060d4052a8.js", "fieldset-wrapper": "porsche-design-system.fieldset-wrapper.9d4272257a5c3c76e940.js", "fieldset": "porsche-design-system.fieldset.3231f110985989e10bbf.js", "flag": "porsche-design-system.flag.f37a54d8b71f15c4f3f7.js", "flex": "porsche-design-system.flex.81370e9e8bc4e2505eb7.js", "flyout": "porsche-design-system.flyout.62df132bd38a8fd0fa50.js", "grid": "porsche-design-system.grid.20ae2e8acbe38ba80516.js", "heading": "porsche-design-system.heading.6444b8b1fc9d66943cf0.js", "headline": "porsche-design-system.headline.61cca0e70f095ee95722.js", "icon": "porsche-design-system.icon.8545f7219ca3469ca8d7.js", "inline-notification": "porsche-design-system.inline-notification.f6c30081a6b9da84bb0a.js", "input-date": "porsche-design-system.input-date.645ec905ecae3ee816ad.js", "input-email": "porsche-design-system.input-email.4e226d75c5f7f0496757.js", "input-number": "porsche-design-system.input-number.59eb687e38221ad5651b.js", "input-password": "porsche-design-system.input-password.f8a825200cad1e5d7b94.js", "input-search": "porsche-design-system.input-search.f5c3dd501fe6e5ae5feb.js", "input-tel": "porsche-design-system.input-tel.624167beed256b50ce31.js", "input-text": "porsche-design-system.input-text.0476822bea691d64e848.js", "input-time": "porsche-design-system.input-time.33e9e17634e26fba0aa8.js", "input-url": "porsche-design-system.input-url.4e6c623708e6c98af47e.js", "link-pure": "porsche-design-system.link-pure.d11a7c7ac05d704b426a.js", "link-social": "porsche-design-system.link-social.0897e48b797fe3b00cab.js", "link-tile-model-signature": "porsche-design-system.link-tile-model-signature.d95e00c493c93b0ad0be.js", "link-tile-product": "porsche-design-system.link-tile-product.59238752fa5584d08858.js", "link-tile": "porsche-design-system.link-tile.2b2fc0153b94f9a177df.js", "link": "porsche-design-system.link.094bfd031f1131f21716.js", "marque": "porsche-design-system.marque.3b34488adf2e0c222ecc.js", "modal": "porsche-design-system.modal.fb5bb0a462775f8e1f99.js", "model-signature": "porsche-design-system.model-signature.d34b37e865dc1dba2bb2.js", "multi-select": "porsche-design-system.multi-select.dac9ea70c7a63c5ad538.js", "optgroup": "porsche-design-system.optgroup.39cd79dc348dac166b36.js", "pagination": "porsche-design-system.pagination.a00e1088a6875b94e375.js", "pin-code": "porsche-design-system.pin-code.d4baa40c3eab7852e91c.js", "popover": "porsche-design-system.popover.cd86f009d1bd3e59cbe1.js", "radio-button-wrapper": "porsche-design-system.radio-button-wrapper.fc0636bea654b24f0aca.js", "scroller": "porsche-design-system.scroller.8aea3cb2d2e7906b571d.js", "segmented-control": "porsche-design-system.segmented-control.35b686820e99656dc25e.js", "select-wrapper": "porsche-design-system.select-wrapper.08501043463da6b5b759.js", "select": "porsche-design-system.select.8202318fcf394ca37a7c.js", "sheet": "porsche-design-system.sheet.b214a48e8909860624cb.js", "spinner": "porsche-design-system.spinner.65859cf7700cb8d41e62.js", "stepper-horizontal": "porsche-design-system.stepper-horizontal.15a23b5ec4c3ccf649f2.js", "switch": "porsche-design-system.switch.391b2b4cf74b6036a020.js", "table": "porsche-design-system.table.8eaf77328a5b1950af25.js", "tabs-bar": "porsche-design-system.tabs-bar.14b58556d6d56780f218.js", "tabs": "porsche-design-system.tabs.aabc4ae1d5f047761dd0.js", "tag-dismissible": "porsche-design-system.tag-dismissible.a4faad3714b45685649f.js", "tag": "porsche-design-system.tag.8d4a4ab06eccf9e44fd8.js", "text-field-wrapper": "porsche-design-system.text-field-wrapper.32f055292e018c155aa8.js", "text-list": "porsche-design-system.text-list.de3c82e2428823bfadeb.js", "text": "porsche-design-system.text.380fed4433efb95aba7c.js", "textarea-wrapper": "porsche-design-system.textarea-wrapper.dc9a9e34566525a5f04e.js", "textarea": "porsche-design-system.textarea.97a914e011d83fe35b2d.js", "toast": "porsche-design-system.toast.5eb2344a8e5cd7658e57.js", "wordmark": "porsche-design-system.wordmark.9bdf3d3b71599f1f90bb.js" };
