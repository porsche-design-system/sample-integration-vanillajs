...
function getFontFaceStylesheet(opts) {
    ...
    return format === 'html'
        ...
        : jsxs(Fragment, { children: [jsx("link", { rel: "preconnect", href: cdnBaseUrl, crossOrigin: "" }), jsx("link", { rel: "dns-prefetch", href: cdnBaseUrl, crossOrigin: "" }), jsx("link", { rel: "stylesheet", href: url, type: "text/css", crossOrigin: "" })] });
}
function getFontFaceStyles(opts) {
    ...
    return format === 'sha256'
        ...
        : format === 'html'
            ...
            : jsx("style", { ...styleProps, dangerouslySetInnerHTML: { __html: styles } });
}
...
function getBrowserSupportFallbackScript(opts) {
    ...
    return format === 'sha256'
        ...
        : format === 'html'
            ...
            : jsx("script", { dangerouslySetInnerHTML: { __html: scriptContent } });
}
...
export { getBrowserSupportFallbackScript, getComponentChunkLinks, getCookiesFallbackScript, getDSRPonyfill, getFontFaceStyles, getFontFaceStylesheet, getFontLinks, getIconLinks, getInitialStyles, getLoaderScript, getMetaTagsAndIconLinks };
