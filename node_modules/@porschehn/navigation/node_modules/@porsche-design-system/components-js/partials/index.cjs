...
const throwIfRunInBrowser = (partialName) => {
    if (isBrowser) {
        throw new Error(`Partials can only be used during build time. You are using '${partialName}' at run time in a browser which defeats the effect of the partial.`);
    }
};
...
function getInitialStyles(opts) {
    ...
    const tagNames = ['p-accordion', 'p-banner', 'p-button', 'p-button-group', 'p-button-pure', 'p-button-tile', 'p-carousel', 'p-checkbox-wrapper', 'p-content-wrapper', 'p-crest', 'p-display', 'p-divider', 'p-fieldset', 'p-fieldset-wrapper', 'p-flex', 'p-flex-item', 'p-flyout', 'p-grid', 'p-grid-item', 'p-heading', 'p-headline', 'p-icon', 'p-inline-notification', 'p-link', 'p-link-pure', 'p-link-social', 'p-link-tile', 'p-link-tile-model-signature', 'p-marque', 'p-modal', 'p-model-signature', 'p-pagination', 'p-popover', 'p-radio-button-wrapper', 'p-scroller', 'p-segmented-control', 'p-segmented-control-item', 'p-select-wrapper', 'p-spinner', 'p-stepper-horizontal', 'p-stepper-horizontal-item', 'p-switch', 'p-table', 'p-table-body', 'p-table-cell', 'p-table-head', 'p-table-head-cell', 'p-table-head-row', 'p-table-row', 'p-tabs', 'p-tabs-bar', 'p-tabs-item', 'p-tag', 'p-tag-dismissible', 'p-text', 'p-text-field-wrapper', 'p-text-list', 'p-text-list-item', 'p-textarea-wrapper', 'p-toast', 'p-wordmark'];
    const tagNamesWithSlottedAnchor = ['p-accordion', 'p-banner', 'p-carousel', 'p-checkbox-wrapper', 'p-display', 'p-flyout', 'p-heading', 'p-headline', 'p-inline-notification', 'p-modal', 'p-popover', 'p-radio-button-wrapper', 'p-select-wrapper', 'p-switch', 'p-table', 'p-tabs', 'p-text', 'p-text-field-wrapper', 'p-text-list', 'p-textarea-wrapper'];
    ...
    const slottedStyles = `%%tagNamesWithSlottedAnchor%% a{color:currentcolor !important;margin-left:-2px !important;margin-right:-2px !important;padding-left:2px !important;border-radius:4px !important;padding-right:2px !important;text-decoration:underline !important}%%tagNamesWithSlottedAnchor%% a:focus{outline:2px solid #1A44EA !important;outline-offset:0 !important}%%tagNamesWithSlottedAnchor%% a:focus:not(:focus-visible){outline-color:transparent !important}%%tagNamesWithSlottedInputIndicator%% input::-webkit-outer-spin-button,%%tagNamesWithSlottedInputIndicator%% input::-webkit-inner-spin-button,%%tagNamesWithSlottedInputIndicator%% input::-webkit-search-decoration,%%tagNamesWithSlottedInputIndicator%% input::-webkit-search-cancel-button,%%tagNamesWithSlottedInputIndicator%% input::-webkit-calendar-picker-indicator{display:none !important}%%tagNamesWithSlottedImage%% img{vertical-align:middle !important}%%tagNamesWithSlottedPictureImage%% picture img{width:100% !important;height:100% !important;object-fit:cover !important}@media(hover:hover){%%tagNamesWithSlottedAnchor%% a{transition:background var(--p-transition-duration,.24s) ease !important}%%tagNamesWithSlottedAnchor%% a:hover{background:rgba(148,149,152,.18) !important}}`
...
Please use only valid component chunk names:
  ${supportedComponentChunkNames.join(', ')}`);
    ...
    const cdnBaseUrl = getCdnBaseUrl(cdn);
    const manifest = { "core": "porsche-design-system.v3.6.1.7aaf2271e6e7dea8aea2.js", "accordion": "porsche-design-system.accordion.fb12c83af3f43a4f8d18.js", "banner": "porsche-design-system.banner.8e164e153bb66c0abf31.js", "button-group": "porsche-design-system.button-group.668cdb670008c98083aa.js", "button-pure": "porsche-design-system.button-pure.c9b4f8a63972c43595f1.js", "button-tile": "porsche-design-system.button-tile.bf9de872dc816fe9063b.js", "button": "porsche-design-system.button.9540b7708c98298f8c20.js", "carousel": "porsche-design-system.carousel.25199c6b897cd16369fc.js", "checkbox-wrapper": "porsche-design-system.checkbox-wrapper.db1282956f4f5ef9b0b3.js", "content-wrapper": "porsche-design-system.content-wrapper.6f234cee629168128d85.js", "crest": "porsche-design-system.crest.197e4ec311ca734c6316.js", "display": "porsche-design-system.display.ac3760d4bf10432742b2.js", "divider": "porsche-design-system.divider.2f2172da915fcd6a1ff9.js", "fieldset-wrapper": "porsche-design-system.fieldset-wrapper.3663786e434e243598a3.js", "fieldset": "porsche-design-system.fieldset.bf28e98848c0c2a0470d.js", "flex": "porsche-design-system.flex.10521a73a403b5288e88.js", "flyout": "porsche-design-system.flyout.524fd92776a266fe939e.js", "grid": "porsche-design-system.grid.4f51d251e707ec2efbf7.js", "heading": "porsche-design-system.heading.844e61bc2f06bcdb4500.js", "headline": "porsche-design-system.headline.6fdb9d514e53b46ef881.js", "icon": "porsche-design-system.icon.e1916652da358ede4376.js", "inline-notification": "porsche-design-system.inline-notification.1070ef0a1c123a0e55a2.js", "link-pure": "porsche-design-system.link-pure.9769111b823a8ef0aead.js", "link-social": "porsche-design-system.link-social.f544223697a8d766e267.js", "link-tile-model-signature": "porsche-design-system.link-tile-model-signature.9a455579582eea9d4942.js", "link-tile": "porsche-design-system.link-tile.e5e7cfa555734faf900c.js", "link": "porsche-design-system.link.ee79f64e02b3a93e4721.js", "marque": "porsche-design-system.marque.5aa953799580c79865c1.js", "modal": "porsche-design-system.modal.055120fe8404aa0a569a.js", "model-signature": "porsche-design-system.model-signature.f33517ff0ed2be7e7e20.js", "pagination": "porsche-design-system.pagination.41f5d7c641ec586b1868.js", "popover": "porsche-design-system.popover.16344737c7d635ed56cc.js", "radio-button-wrapper": "porsche-design-system.radio-button-wrapper.a9d257c9db1de1d2627e.js", "scroller": "porsche-design-system.scroller.b82dcfe63475a4d8d919.js", "segmented-control": "porsche-design-system.segmented-control.db3a349064633a150879.js", "select-wrapper": "porsche-design-system.select-wrapper.948447a10085889f21d6.js", "spinner": "porsche-design-system.spinner.4b590fdf0b32aa017fb5.js", "stepper-horizontal": "porsche-design-system.stepper-horizontal.c0387b0ababcb867ffa0.js", "switch": "porsche-design-system.switch.d3371a4ab16063a0f206.js", "table": "porsche-design-system.table.afcad59970053bc23440.js", "tabs-bar": "porsche-design-system.tabs-bar.eaeef50153ab300a6ada.js", "tabs": "porsche-design-system.tabs.88c1cc889de350f0a3df.js", "tag-dismissible": "porsche-design-system.tag-dismissible.06468f91e3c367c8fce1.js", "tag": "porsche-design-system.tag.711e6f06e13e36ba71c2.js", "text-field-wrapper": "porsche-design-system.text-field-wrapper.6659d3c62df05cb71993.js", "text-list": "porsche-design-system.text-list.c41b2a8c9e069f99c83c.js", "text": "porsche-design-system.text.54a70166ea26c08a4552.js", "textarea-wrapper": "porsche-design-system.textarea-wrapper.e4de824a2d0743877393.js", "toast": "porsche-design-system.toast.1f6977589c9b838f618b.js", "wordmark": "porsche-design-system.wordmark.d2211aada22d9833a655.js" };
