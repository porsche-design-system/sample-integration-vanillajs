...
import { _cssVariableGridSafeZone, _gridSafeZoneBase, _cssVariableGridExtendedSpanOneHalf, _cssVariableGridBasicSpanOneHalf, _cssVariableGridBasicSpanOneThird, _cssVariableGridBasicSpanTwoThirds, _cssVariableGridNarrowSpanOneHalf, _gridWidthMin, _gridWidthMax, _gridSafeZoneS, _gridSafeZoneXXL } from './gridShared.mjs';
...
const gridStyle = {
    ...
    margin: 0,
    padding: `0 calc(50vw - ${_gridWidthMax} / 2)`,
