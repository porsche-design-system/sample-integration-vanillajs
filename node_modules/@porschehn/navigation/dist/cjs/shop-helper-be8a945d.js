...
function isShopAvailable(locale, app) {
  ...
  return shopList !== undefined && shopList.includes(locale) && app === helper.Application.shop;
}
...
function modifyShopItemDependingOnMarket(locale, app, content) {
  ...
  if (shop === null)
    return content;
  if (externalShop && app !== helper.Application.shop) {
...
function shopNotAvailableOnGlobalPages(shop, locale, app) {
  return (!(shop === null || shop === void 0 ? void 0 : shop.availableLocales.includes(locale)) ||
    ((shop === null || shop === void 0 ? void 0 : shop.availableLocalesOnlyForShop.includes(locale)) && app !== helper.Application.shop));
}
...
function getAvailableShopVariables() {
  ...
  const username = helper.getUsername(loggedInState, (myPorsche === null || myPorsche === void 0 ? void 0 : myPorsche.loggedInFallback) || '');
...
exports.handleFilledIcon = handleFilledIcon;
...
//# sourceMappingURL=shop-helper-be8a945d.js.map