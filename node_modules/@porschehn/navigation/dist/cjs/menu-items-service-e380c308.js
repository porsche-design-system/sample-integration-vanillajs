...
function getLevel1Items(content, dealerSearchResults, locale, loggedInState, unreadMessagesCount, userConsentGiven) {
  ...
  if (savedDealer !== undefined && ((_b = abTestingConstructorService.dealerSearchResultsStore.state.results) === null || _b === void 0 ? void 0 : _b.length) != 1) {
  ...
  if (shop !== null && shop.text !== '') {
    const shopItem = {
      ...
      analyticsId: shop.id,
      text: shop.text,
      link: app !== naviError.Application.shop ? shop.link : undefined,
  ...
  if (isDealerSearchEnabled(locale, userConsentGiven)) {
    const savedDealerName = navContentStore.splitLocale(locale).language === 'en'
      ...
      : naviError.isString(savedDealer === null || savedDealer === void 0 ? void 0 : savedDealer.ppnDealer.nameLocalized)
        ? savedDealer === null || savedDealer === void 0 ? void 0 : savedDealer.ppnDealer.nameLocalized
        : savedDealer === null || savedDealer === void 0 ? void 0 : savedDealer.ppnDealer.name;
    if (naviError.isString(savedDealerName)) {
  ...
  if (myPorsche !== null) {
    ...
    const username = isLoggedIn ? naviError.getUsername(loggedInState, myPorsche.loggedInFallback) : undefined;
    menu.push({
...
function getMenuContent(content, routingKey$1, topLevelRoutingKey) {
  ...
  if (naviError.isString(menuContent.experienceName)) {
...
function getBackButtonText(content, previousRoutingKey) {
  if (!naviError.isString(previousRoutingKey)) {
    return '';
  }
...
function getSubtext(topLevelRoutingKey, activeRoutingKey, locale) {
  ...
  if (topLevelRoutingKey === routingKey.RoutingKeys.MY_PORSCHE) {
    const isLoggedIn = naviError.IsLoggedIn(loggedInState);
    return isLoggedIn ? naviError.getUsername(loggedInState, (myPorsche === null || myPorsche === void 0 ? void 0 : myPorsche.loggedInFallback) || '') : '';
  }
  ...
  if (topLevelRoutingKey === routingKey.RoutingKeys.MODELS) {
    if (naviError.isString(activeRoutingKey)) {
...
//# sourceMappingURL=menu-items-service-e380c308.js.map