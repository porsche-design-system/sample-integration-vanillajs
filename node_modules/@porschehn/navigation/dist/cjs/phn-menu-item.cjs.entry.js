...
require('./global-data-layer-service-534dfa5c.js');
require('./analytics-manager-4e31846c.js');
...
function MenuItemText({ text, size, subtext, fontWeight }) {
  return (index.h("div", { class: "skeleton-item" },
    ...
    helper.isString(subtext) ? (index.h("div", { class: "text-limit" },
...
const MenuItem = class {
  ...
  render() {
    const body = (index.h("div", { class: "phn-flex-row phn-align-center" }, this.existsSlot('media') ? (index.h("div", { class: "media-container skeleton-item" }, index.h("slot", { name: "media" }))) : null, index.h(Icon, { isLoading: this.isLoading, icon: this.iconLeft }), !this.isModels && helper.isString(this.text) ? (index.h(MenuItemText, { size: this.size, text: this.text, subtext: this.subtext, fontWeight: this.fontWeight })) : undefined, this.existsSlot('suffix') ? (index.h("div", null, index.h("slot", { name: "suffix" }))) : null));
    if (helper.isString(this.link)) {
      return (index.h(index.Host, { class: this.variant }, index.h("phn-p-link-pure", { class: `${helper.isString(this.iconLeft) ? 'has-icon' : ''}`, icon: helper.isString(this.iconRight) ? this.iconRight : 'none', "align-label": "left", stretch: helper.isString(this.iconRight) ? 'true' : 'false', "data-id": this.elementId, target: this.target, onClick: () => {
          this.sendDataLayerEvent(navContentStore.ClickElementTypes.Link, this.elementId);
        } }, index.h("a", { href: this.link }, body))));
    }
    return (index.h(index.Host, { class: this.variant }, index.h("phn-p-button-pure", { class: `${helper.isString(this.iconLeft) ? 'has-icon' : ''}`, size: "inherit", icon: helper.isString(this.iconRight) ? this.iconRight : 'none', "align-label": "left", stretch: helper.isString(this.iconRight) ? 'true' : 'false', "data-id": this.elementId, onClick: () => {
