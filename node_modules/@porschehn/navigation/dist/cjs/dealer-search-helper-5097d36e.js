...
function getOpeningHours(openingHoursData) {
  const { openingHours } = navContentStore.navContentStore.state.dealer;
  if (!openingHours) {
    return '';
  }
  const WEEK_DAYS = [
...
exports.getRegionSpecificCountry = getRegionSpecificCountry;
exports.sanitizeDealerHomepage = sanitizeDealerHomepage;
exports.showDealerSearchDropdown = showDealerSearchDropdown;

//# sourceMappingURL=dealer-search-helper-5097d36e.js.map