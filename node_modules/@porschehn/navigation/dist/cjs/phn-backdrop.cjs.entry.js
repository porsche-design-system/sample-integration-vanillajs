...
const Backdrop = class {
  ...
  sendDataAnalyticsEvent() {
    ...
    globalDataLayerService.globalDataLayerService.pushDataLayerEvent(navContentStore.EventActions.MENU_CLOSE_CLICK, {
      ...
      componentDisplay: {
        displayElementType: analyticsManager.analyticsManager.calculateDisplayElementType(routingManager.getCurrentRoute(), navContentStore.ElementTypes.backdrop),
  ...
  componentWillLoad() {
    if (featureToggles.windowService.hasScrollbar()) {
      featureToggles.windowService.lockScroll();
    }
  }
  disconnectedCallback() {
    if (featureToggles.windowService.hasScrollbar()) {
      featureToggles.windowService.unlockScroll();
    }
  }
  render() {
