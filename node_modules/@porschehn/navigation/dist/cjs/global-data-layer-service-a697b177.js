...
function getEnvironmentAbbreviation(env) {
  switch (env) {
    case navContentStore.Environments.PRODUCTION:
      return 'P';
    case navContentStore.Environments.PREVIEW:
      return 'PP';
    default:
      return 'K';
  }
...
class GlobalDataLayerService {
  ...
  setDefaultProperties(locale, pageName) {
    let defaultGDLProperties = {
      context: { applicationId: navContentStore.DATA_LAYER_APP_ID },
      visitor: { loginStatus: false }
    };
    try {
      const { country, language } = navContentStore.splitLocale(locale);
      defaultGDLProperties = Object.assign(Object.assign({}, defaultGDLProperties), { context: Object.assign(Object.assign({}, defaultGDLProperties.context), { country, language, applicationName: navContentStore.DATA_LAYER_APPLICATION_NAME }) });
    }
    catch (err) {
      // throw the error away
    }
    if (naviError.isString(pageName)) {
...
exports.globalDataLayerService = globalDataLayerService;

//# sourceMappingURL=global-data-layer-service-a697b177.js.map