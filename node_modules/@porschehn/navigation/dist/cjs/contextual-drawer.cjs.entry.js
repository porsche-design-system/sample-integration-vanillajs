...
const ContextualDrawer = class {
  ...
  closeDrawer() {
    animationManager.animationManager.play('closeContextualDrawer').then(() => {
      this.phnContextualDrawerStatus.emit({ status: helper.DrawerStatusValues.finishClosing });
      this.isDrawerOpened = false;
    });
  }
  componentDidLoad() {
    registerContextualDrawerOpening({
      onStartOpening: () => {
        this.phnContextualDrawerStatus.emit({ status: helper.DrawerStatusValues.startOpening });
      ...
      onFinishOpening: () => {
        this.phnContextualDrawerStatus.emit({ status: helper.DrawerStatusValues.finishOpening });
      }
    });
    registerContextualDrawerClosing({
      onStartClosing: () => {
        this.phnContextualDrawerStatus.emit({ status: helper.DrawerStatusValues.startClosing });
      }
    });
  }
  render() {
