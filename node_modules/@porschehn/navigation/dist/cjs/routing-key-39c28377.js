...
exports.RoutingKeyPointers = void 0;
...
})(exports.RoutingKeyPointers || (exports.RoutingKeyPointers = {}));
function constructRoutingKey(...args) {
  return args
    .reduce((segments, arg) => [...segments, ...naviError.getString(arg).split('/')], [])
    .filter(Boolean)
    .join('/');
}
...
exports.RoutingKeys = RoutingKeys;
exports.constructRoutingKey = constructRoutingKey;
exports.determineMainDrawerLevel = determineMainDrawerLevel;
exports.findTopLevelRoutingKey = findTopLevelRoutingKey;
exports.getDealerDetailsRoutingKey = getDealerDetailsRoutingKey;
exports.getLastRoutingSegment = getLastRoutingSegment;
exports.getModelsRoutingKey = getModelsRoutingKey;
exports.getMyPorscheRoutingKey = getMyPorscheRoutingKey;
exports.getPreviousRoutingKey = getPreviousRoutingKey;
exports.getVehiclePurchaseRoutingKey = getVehiclePurchaseRoutingKey;
exports.removeLastRoutingSegment = removeLastRoutingSegment;

//# sourceMappingURL=routing-key-39c28377.js.map