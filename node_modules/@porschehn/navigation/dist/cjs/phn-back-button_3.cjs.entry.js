...
const Heading = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("phn-p-heading", { size: "inherit" }, this.text), naviError.isString(this.subtext) ? (index.h("div", { class: "text-limit" }, index.h("phn-p-text", { color: "contrast-high", size: "xx-small", tag: "div", ellipsis: "true" }, this.subtext))) : null));
  }
};
...
const SignatureHeading = class {
  ...
  render() {
    return (index.h(index.Fragment, null, index.h("phn-p-model-signature", { model: this.text.toLowerCase(), size: "inherit", class: "model-signature" }), naviError.isString(this.subtext) && !naviError.isModelFuelTypeGasoline(this.text) ? (index.h("phn-p-text", { color: "inherit", class: "subtext", weight: "regular", size: "x-small", tag: "div", ellipsis: "true", "data-test-id": "subtext" }, this.subtext)) : null));
  }
};
