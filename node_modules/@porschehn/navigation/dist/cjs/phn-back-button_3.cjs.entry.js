...
const BackButton = class {
  ...
  sendDataLayerEvent() {
    globalDataLayerService.globalDataLayerService.pushDataLayerEvent(navContentStore.EventActions.MENU_BACK_CLICK, {
      componentClick: {
      ...
      componentDisplay: {
        ...
        displayElementType: analyticsManager.analyticsManager.calculateDisplayElementType(this.activeRoutingKey, navContentStore.ElementTypes.backButton, true),
        displayElementName: this.text
      }
    });
  }
  render() {
    return (index.h(index.Host, null, index.h("phn-p-button-pure", { size: "inherit", icon: "arrow-head-left", class: "back-button-text-link", aria: { 'aria-label': 'Back to Menu' }, onClick: () => this.sendDataLayerEvent() }, this.text)));
  }
};
...
const Heading = class {
  ...
  render() {
    return (index.h(index.Host, null, index.h("phn-p-heading", { size: "inherit" }, this.text), helper.isString(this.subtext) ? (index.h("div", { class: "text-limit" }, index.h("phn-p-text", { color: "contrast-high", size: "xx-small", tag: "div", ellipsis: "true" }, this.subtext))) : null));
  }
};
Heading.style = headingCss;
...
const SignatureHeading = class {
  ...
  render() {
    return (index.h(index.Fragment, null, index.h("phn-p-model-signature", { model: this.text.toLowerCase(), size: "inherit", class: "model-signature" }), helper.isString(this.subtext) && !helper.isModelFuelTypeGasoline(this.text) ? (index.h("phn-p-text", { color: "inherit", class: "subtext", weight: "regular", size: "x-small", tag: "div", ellipsis: "true", "data-test-id": "subtext" }, this.subtext)) : null));
  }
};
SignatureHeading.style = signatureHeadingCss;

exports.phn_back_button = BackButton;
exports.phn_heading = Heading;
exports.phn_signature_heading = SignatureHeading;

//# sourceMappingURL=phn-back-button_3.cjs.entry.js.map