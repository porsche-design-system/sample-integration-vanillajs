...
const helper$1 = require('./helper-5035b2a4.js');
...
const MainDrawerContent = ({ activeRoutingKey, locale, breakpoint, backButtonText, onClickBack, receivedContent }) => (index.h("div", { class: "drawer-content" },
  index.h("div", { class: "main-drawer-header" }, helper.isString(backButtonText) ? (index.h("phn-back-button", { class: "back-button", onClick: onClickBack, text: backButtonText, analyticsId: navContentStore.navContentStore.state.menu.id, activeRoutingKey: activeRoutingKey })) : null),
...
const SideDrawerContent = ({ activeRoutingKey, locale, backButtonText, onClickBack }) => {
  return (index.h("div", { class: "drawer-content" },
    ...
    index.h("div", { class: "side-drawer-header" }, helper.isString(backButtonText) ? (index.h("phn-back-button", { class: "back-button", onClick: onClickBack, text: backButtonText, analyticsId: navContentStore.navContentStore.state.menu.id, activeRoutingKey: activeRoutingKey })) : null),
