...
const SideDrawer = class {
  ...
  render() {
    ...
    const sideDrawerItems = menuItemsService.getSideDrawerItems(navContentStore.navContentStore.state, dealerSearchResultsStore.dealerSearchResultsStore.state, this.locale, loggedInState, unreadMessagesCount, this.activeRoutingKey, userConsent);
