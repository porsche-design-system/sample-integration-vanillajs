...
export interface PhnDealerSearchResultsCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLPhnDealerSearchResultsElement;
}
...
export interface PhnModelsCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLPhnModelsElement;
}
...
export interface PhnSingleDrawerCustomEvent<T> extends CustomEvent<T> {
    detail: T;
    target: HTMLPhnSingleDrawerElement;
}
declare global {
...
declare namespace LocalJSX {
    ...
    interface PhnDealerSearchResults {
        "breakpoint": number;
        "locale": string;
        "onMobileMenuItemClick"?: (event: PhnDealerSearchResultsCustomEvent<string[]>) => void;
        "showOverlay"?: boolean;
    }
    interface PhnDoubleDrawer {
        "breakpoint": number;
    ...
    interface PhnDrawerHeader {
        ...
        "breakpoint": number;
        "locale"?: string;
        "onClickDrawerHeaderBack"?: (event: PhnDrawerHeaderCustomEvent<void>) => void;
    ...
    interface PhnModels {
        "breakpoint": number;
        "onMobileMenuItemClick"?: (event: PhnModelsCustomEvent<string[]>) => void;
        "showHeadline"?: boolean;
    }
    interface PhnMyPorscheIconButton {
        "mode"?: NavigationModeType;
    ...
    interface PhnSingleDrawer {
        "breakpoint": number;
        "locale": string;
        "onBackdropClosed"?: (event: PhnSingleDrawerCustomEvent<void>) => void;
        "onDrawerChanged"?: (event: PhnSingleDrawerCustomEvent<boolean>) => void;
        "onDrawerClosed"?: (event: PhnSingleDrawerCustomEvent<void>) => void;
        "onDrawerStartsClosing"?: (event: PhnSingleDrawerCustomEvent<void>) => void;
        "onPhnDrawerStatus"?: (event: PhnSingleDrawerCustomEvent<{
    status: DrawerStatusTypes;
  }>) => void;
        "receivedContent"?: boolean;
        "routingKeyHistory": string[];
