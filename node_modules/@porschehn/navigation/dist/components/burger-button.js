...
import { N as NavigationTheme, q as NavigationMode, r as constructThemeClass, t as getRightTheme } from './helper.js';
...
const BurgerButton = /*@__PURE__*/ proxyCustomElement(class BurgerButton extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement() {
  ...
  const components = ["phn-burger-button"];
  components.forEach(tagName => { switch (tagName) {
    case "phn-burger-button":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, BurgerButton);
      }
      break;
  } });
}
...
export { BurgerButton as B, defineCustomElement as d };
