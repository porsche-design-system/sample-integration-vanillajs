...
import { b as getLevel1Items } from './analytics-manager.js';
...
import { o as isDesktop, v as MenuItemVariant } from './helper.js';
import { i as isShopAvailable } from './shop-helper.js';
import { b as goTo } from './routing-manager.js';
...
const Level1 = /*@__PURE__*/ proxyCustomElement(class Level1 extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement() {
  ...
  const components = ["phn-level-1", "phn-menu-item"];
  components.forEach(tagName => { switch (tagName) {
    case "phn-level-1":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, Level1);
      }
      break;
    case "phn-menu-item":
      if (!customElements.get(tagName)) {
...
export { Level1 as L, defineCustomElement as d };
