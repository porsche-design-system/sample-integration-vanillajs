...
import { h as RoutingKeyPointers, f as findTopLevelRoutingKey, R as RoutingKeys, b as getLastRoutingSegment } from './routing-key.js';
...
import { i as isOpened, A as AnimationSequences, d as isClosed, r as reset, e as isOpening } from './routing-manager.js';
import { N as NavigationTheme, q as NavigationMode, A as Application, o as isDesktop, T as IsKeyboardClick, z as focusOnElement, b as isString, j as breakpoint, r as constructThemeClass, i as isPromise } from './helper.js';
import { i as isShopAvailable } from './shop-helper.js';
import { T as Timeout, c as componentsOnReady } from './timeout.js';
import { i as isPlayingDoubleDrawerAnimation, d as defineCustomElement$i } from './double-drawer.js';
import { n as navStateStore } from './nav-state-store.js';
import { d as defineCustomElement$u } from './contextual-drawer2.js';
import { d as defineCustomElement$t } from './autocomplete-search-field.js';
import { d as defineCustomElement$s } from './back-button.js';
import { d as defineCustomElement$r } from './backdrop.js';
import { d as defineCustomElement$q } from './burger-button.js';
import { d as defineCustomElement$p } from './car-body-types-drawer.js';
import { d as defineCustomElement$o } from './dealer-details-drawer.js';
import { d as defineCustomElement$n } from './dealer-search-by-number-of-dealers.js';
import { d as defineCustomElement$m } from './dealer-search-form.js';
import { d as defineCustomElement$l } from './dealer-search-form-dropdown.js';
import { d as defineCustomElement$k } from './dealer-search-form-geolocation.js';
import { d as defineCustomElement$j } from './dealer-search-results.js';
import { d as defineCustomElement$h } from './drawer-header.js';
import { d as defineCustomElement$g } from './heading.js';
import { d as defineCustomElement$f } from './level-0-icons.js';
import { d as defineCustomElement$e } from './level-1.js';
import { d as defineCustomElement$d } from './logo.js';
import { d as defineCustomElement$c } from './menu.js';
import { d as defineCustomElement$b } from './menu-item.js';
import { d as defineCustomElement$a } from './menu-item-card.js';
import { d as defineCustomElement$9 } from './models.js';
import { d as defineCustomElement$8 } from './my-porsche-icon-button.js';
import { d as defineCustomElement$7 } from './myporsche-drawer.js';
import { d as defineCustomElement$6 } from './myporsche-login.js';
import { d as defineCustomElement$5 } from './router.js';
import { d as defineCustomElement$4 } from './side-drawer.js';
import { d as defineCustomElement$3 } from './side-drawer-item.js';
import { d as defineCustomElement$2 } from './signature-heading.js';
import { d as defineCustomElement$1 } from './single-drawer.js';
...
const Level0 = /*@__PURE__*/ proxyCustomElement(class Level0 extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  render() {
    return (h(Host, { class: `${constructThemeClass(this.mode, this.theme)}-theme themed-background` }, h("header", { class: this.limitedWidth ? 'limited-width' : '' }, isOpened() || isOpening() ? (h("phn-backdrop", { style: this.isLoading ? { display: 'none' } : {} })) : null, h("div", { class: "level-0-content" }, !this.displayLogoOnly ? (h("div", { class: "level-0-content-icons" }, h("phn-level-0-icons", { locale: this.locale, theme: this.theme, mode: this.mode, app: this.app, breakpoint: this.breakpoint, isLoading: this.isLoading, isNavigationLoaded: this.isNavigationLoaded }, h("div", { class: "level-0-content-logo" }, h("phn-logo", { app: this.app, locale: this.locale, theme: this.theme, mode: this.mode, size: this.getLogoSize(), breakpoint: this.breakpoint, style: this.isNavigationLoaded ? {} : { display: 'none' } }), !this.isNavigationLoaded ? (h("div", { class: "crest-skeleton skeleton-container" }, this.breakpoint > breakpoint.xs ? h("span", { class: "label-bone" }) : h("span", { class: "crest-bone" }))) : null)), isShopAvailable(this.locale, this.app) ? (h("contextual-drawer", null, h("div", { slot: "contextual_drawer_header" }, h("slot", { name: "contextual_drawer_header" })))) : null)) : (h("div", { class: "level-0-content-logo" }, h("phn-logo", { app: this.app, locale: this.locale, theme: this.theme, mode: this.mode, size: this.getLogoSize(), breakpoint: this.breakpoint, style: this.isNavigationLoaded ? {} : { display: 'none' } }), !this.isNavigationLoaded ? (h("div", { class: "crest-skeleton skeleton-container" }, this.breakpoint > breakpoint.xs ? h("span", { class: "label-bone" }) : h("span", { class: "crest-bone" }))) : null)))), !isClosed() ? (isDesktop(this.breakpoint) ? (h("phn-double-drawer", { class: "drawer", style: this.isLoading ? { display: 'none' } : {}, routingKeyHistory: this.routingKeyHistory, routingKeyPointer: this.routingKeyPointer, breakpoint: this.breakpoint, initialUsingKeyboard: this.usingKeyboard, locale: this.locale, receivedContent: this.receivedContent })) : (h("phn-single-drawer", { class: "drawer", style: this.isLoading ? { display: 'none' } : {}, breakpoint: this.breakpoint, usingKeyboard: this.usingKeyboard, locale: this.locale, receivedContent: this.receivedContent }))) : null));
  }
  get el() { return this; }
...
function defineCustomElement() {
  ...
  const components = ["phn-level-0", "contextual-drawer", "phn-autocomplete-search-field", "phn-back-button", "phn-backdrop", "phn-burger-button", "phn-car-body-types-drawer", "phn-dealer-details-drawer", "phn-dealer-search-by-number-of-dealers", "phn-dealer-search-form", "phn-dealer-search-form-dropdown", "phn-dealer-search-form-geolocation", "phn-dealer-search-results", "phn-double-drawer", "phn-drawer-header", "phn-heading", "phn-level-0-icons", "phn-level-1", "phn-logo", "phn-menu", "phn-menu-item", "phn-menu-item-card", "phn-models", "phn-my-porsche-icon-button", "phn-myporsche-drawer", "phn-myporsche-login", "phn-router", "phn-side-drawer", "phn-side-drawer-item", "phn-signature-heading", "phn-single-drawer"];
  components.forEach(tagName => { switch (tagName) {
    case "phn-level-0":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, Level0);
      }
      break;
...
export { Level0 as L, defineCustomElement as d };
