...
import { D as DrawerStatusValues } from './helper.js';
...
const ContextualDrawer = /*@__PURE__*/ proxyCustomElement(class ContextualDrawer extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
  ...
  static get style() { return contextualDrawerCss; }
    ...
    "isDrawerOpened": [32]
  }, [[8, "phnCloseContextualDrawer", "closeContextualDrawer"], [8, "phnOpenContextualDrawer", "openContextualDrawer"]]]);
function defineCustomElement() {
  if (typeof customElements === "undefined") {
    return;
  }
  const components = ["contextual-drawer"];
  components.forEach(tagName => { switch (tagName) {
    case "contextual-drawer":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, ContextualDrawer);
      }
      break;
  } });
}
...
export { ContextualDrawer as C, defineCustomElement as d };

//# sourceMappingURL=contextual-drawer2.js.map