...
import { A as Application, t as getRightTheme, N as NavigationTheme, q as NavigationMode, j as breakpoint, T as IsKeyboardClick, o as isDesktop } from './helper.js';
...
import { i as isShopAvailable, h as handleFilledIcon, s as shopStateStore } from './shop-helper.js';
...
function shopIcons({ locale, app, mode, theme, isNavigationLoaded, isDesktop }) {
  ...
  return {
    leftIcons: isShopAvailable(locale, app) ? (h("div", { class: "icon" },
      ...
      !isNavigationLoaded ? pureButtonSkeleton() : null)) : null,
    rightIcons: isShopAvailable(locale, app) ? (h(Fragment, null,
      isDesktop ? (h("div", { class: "icon" },
        h("phn-p-link-pure", { target: '_self', "hide-label": "true", icon: "none", theme: getRightTheme(theme, mode), style: isNavigationLoaded ? {} : { display: 'none' }, className: "wishlist-link", "data-test-id": "wishlist-link", onClick: () => {
            sendDataLayerEventShoppingCart(shopWishlistLink, 'mainmenu.shop.wishlist', 'Wishlist');
          } },
          h("a", { href: shopWishlistLink, "aria-label": getAriaLabelForWishlist() },
            h("div", { class: "icon-flex" },
              h(BadgeCount, { numberOfItems: shopInformation.wishlistItemsNumber, theme: theme, mode: mode }),
              h("phn-p-icon", { theme: getRightTheme(theme, mode), name: handleFilledIcon('heart', shopInformation.wishlistItemsNumber), "data-test-id": "wishlist-link-icon" })))))) : null,
      ...
      h("div", { class: "icon" },
        h("phn-p-link-pure", { target: '_self', "hide-label": "true", icon: "none", theme: getRightTheme(theme, mode), style: isNavigationLoaded ? {} : { display: 'none' }, class: "shopping-cart-link", "data-test-id": "shopping-cart-link", onClick: () => {
          ...
          h("a", { href: shopCartLink, "aria-label": getAriaLabelForShoppingBag() },
            h("div", { class: "icon-flex" },
              h(BadgeCount, { numberOfItems: shopInformation.numberOfShoppingItems, theme: theme, mode: mode }),
              h("phn-p-icon", { theme: getRightTheme(theme, mode), name: handleFilledIcon('shopping-bag', shopInformation.numberOfShoppingItems), "data-test-id": "shopping-cart-link-icon" })))),
        !isNavigationLoaded ? pureButtonSkeleton() : null))) : null
  };
}
