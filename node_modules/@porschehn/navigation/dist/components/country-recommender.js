...
import { s as splitLocale, i as isCountryInOneOfRegions, g as globalDataLayerService, E as EventActions, C as ClickElementTypes } from './global-data-layer-service.js';
import { A as Application, p as constructCacheKey, b as getConfig, g as getHTMLElement, a as isString } from './helper.js';
import { m as modifyShopItemDependingOnMarket } from './shop-helper.js';
import { N as NaviError, a as NaviErrorTypes } from './navi-error.js';
...
const CountryRecommender = /*@__PURE__*/ proxyCustomElement(class CountryRecommender extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement() {
  ...
  const components = ["phn-country-recommender"];
  components.forEach(tagName => { switch (tagName) {
    case "phn-country-recommender":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, CountryRecommender);
      }
      break;
  } });
}
...
export { CountryRecommender as C, defineCustomElement as d, fetchContent as f };
