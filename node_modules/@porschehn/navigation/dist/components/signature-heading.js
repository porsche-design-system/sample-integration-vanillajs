...
import { a as isString, z as isModelFuelTypeGasoline } from './helper.js';
...
const SignatureHeading = /*@__PURE__*/ proxyCustomElement(class SignatureHeading extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
    this.text = undefined;
...
function defineCustomElement() {
  ...
  const components = ["phn-signature-heading"];
  components.forEach(tagName => { switch (tagName) {
    case "phn-signature-heading":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, SignatureHeading);
      }
      break;
  } });
}
...
export { SignatureHeading as S, defineCustomElement as d };
