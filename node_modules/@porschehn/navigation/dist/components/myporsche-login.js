...
const MyPorscheLogin = /*@__PURE__*/ proxyCustomElement(class MyPorscheLogin extends HTMLElement {
  constructor() {
    super();
    this.__registerHost();
...
function defineCustomElement() {
  ...
  const components = ["phn-myporsche-login"];
  components.forEach(tagName => { switch (tagName) {
    case "phn-myporsche-login":
      if (!customElements.get(tagName)) {
        customElements.define(tagName, MyPorscheLogin);
      }
      break;
  } });
}
...
export { MyPorscheLogin as M, defineCustomElement as d };
