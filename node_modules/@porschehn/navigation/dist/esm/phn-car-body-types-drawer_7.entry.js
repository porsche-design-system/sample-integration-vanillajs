import { r as registerInstance, d as getAssetPath, h, F as Fragment, H as Host, g as getElement, c as createEvent } from './index-192f2625.js';
import { g as globalDataLayerService } from './global-data-layer-service-dc914682.js';
import { E as EventActions, C as ClickElementTypes, h as ElementTypes, n as navStateStore, s as splitLocale, b as navContentStore } from './nav-content-store-238e6137.js';
import { o as breakpoint, i as isString, a as getConfig, t as getHTMLElement, l as isDesktop, P as MenuItemVariant, Q as getImageSize, I as IsLoggedIn } from './helper-76937d0b.js';
import { c as componentsOnReady } from './ready-c2782001.js';
import { T as Timeout } from './timeout-aa680917.js';
import { a as analyticsManager } from './analytics-manager-8f2e83f9.js';
import { g as getCurrentRoute, c as goTo, j as addRoute } from './routing-manager-2bba85b2.js';
import { s as showDealerSearchDropdown } from './dealer-search-helper-d774becd.js';
import { e as getLevel1Items, f as getMenuContent } from './menu-items-service-0969229a.js';
import { d as dealerSearchResultsStore } from './dealer-search-results-store-f00291b6.js';
import { i as isShopAvailable, s as shopStateStore, f as filterWishlistItemsByAuthStatus, g as getIconNameByMenuItemId, b as getAvailableShopVariables } from './shop-helper-e09f5b0c.js';
import { i as getVehiclePurchaseRoutingKey, c as constructRoutingKey, h as getModelsRoutingKey, j as getMyPorscheRoutingKey, a as RoutingKeys, f as findTopLevelRoutingKey, g as getLastRoutingSegment } from './routing-key-808e9d26.js';
import { f as finderStateStore } from './finder-state-store-313ab47f.js';
import { f as featureToggles } from './feature-toggles-f5a05f06.js';
import './router-store-26b5bff5.js';
import './animation-manager-2e28abcf.js';
import './animations-8383aa25.js';
...
function MenuItemLink({ content, count, showSkeleton }) {
  return content ? (h(Fragment, null,
    h("phn-menu-item", { elementId: getVehiclePurchaseRoutingKey(content.id), key: content.id, class: `${showSkeleton ? 'skeleton' : 'vehiclepurchase-link'}`, analyticsId: content.id, text: content.text, link: content.link, datalayerEventAction: EventActions.NAVIGATION_LINK_CLICK, role: "listitem" },
      h(MenuItemCountIndicator$1, { count: count })))) : null;
}
...
function ShopSection({ activeRoutingKey, breakpoint, receivedContent, loginEvent }) {
  ...
  return (h(Fragment, null,
    h("phn-menu", { item: displayedContent, showHeadline: showHeadline, receivedContent: receivedContent }),
...
function VehiclePurchaseSection({ activeRoutingKey, topLevelRoutingKey, breakpoint, receivedContent }) {
  ...
  return h("phn-menu", { item: displayedContent, showHeadline: showHeadline, receivedContent: receivedContent });
}
...
export { CarBodyTypeDrawer as phn_car_body_types_drawer, DealerSearchForm as phn_dealer_search_form, Level1 as phn_level_1, Menu as phn_menu, Models as phn_models, MyPorscheDrawer as phn_myporsche_drawer, Router as phn_router };
