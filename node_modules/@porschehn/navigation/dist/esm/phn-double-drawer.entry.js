import { h, r as registerInstance, c as createEvent, F as Fragment, H as Host, g as getElement } from './index-3fb28577.js';
import { R as RoutingKeyPointers, f as findTopLevelRoutingKey, a as RoutingKeys } from './routing-key-12b2ffae.js';
...
import { a as getBackButtonText } from './menu-items-service-6c03b266.js';
import { a as navContentStore, e as DisplayElementTypes, E as EventActions, f as ElementTypes, C as ClickElementTypes } from './nav-content-store-ad934a75.js';
import { i as isString, p as focusOnElement, u as getHTMLElement, F as FOCUSABLE_ELEMENTS_SELECTOR, B as DrawerStatusValues } from './navi-error-d2e07707.js';
import { r as registerOpenDoubleDrawerSequence, a as registerCloseDoubleDrawerSequence, b as registerBackToPreviousMenuSequence, c as registerForwardToNextMenuSequence, d as registerTransitionSequence } from './double-drawer-animation-sequences-bda860c6.js';
import { g as getAllFocusableElements } from './helper-30548d3f.js';
...
const MainDrawerContent = ({ activeRoutingKey, locale, breakpoint, backButtonText, onClickBack, receivedContent }) => (h("div", { class: "drawer-content" },
  h("div", { class: "main-drawer-header" }, isString(backButtonText) ? (h("phn-back-button", { class: "back-button", onClick: onClickBack, text: backButtonText, analyticsId: navContentStore.state.menu.id, activeRoutingKey: activeRoutingKey })) : null),
...
const SideDrawerContent = ({ activeRoutingKey, locale, backButtonText, onClickBack }) => {
  return (h("div", { class: "drawer-content" },
    ...
    h("div", { class: "side-drawer-header" }, isString(backButtonText) ? (h("phn-back-button", { class: "back-button", onClick: onClickBack, text: backButtonText, analyticsId: navContentStore.state.menu.id, activeRoutingKey: activeRoutingKey })) : null),
...
const DoubleDrawer = class {
  ...
  render() {
    ...
    return (h(Host, { role: "dialog", "aria-modal": "true", "aria-label": "navigation modal dialog", style: { left: '-1000px' } }, h("phn-p-button", { variant: "secondary", class: "close-button", theme: "dark", "hide-label": "true", icon: 'close', aria: "{ 'aria-label': 'close modal dialog' }", "data-test-id": "close-button", onClick: () => {
