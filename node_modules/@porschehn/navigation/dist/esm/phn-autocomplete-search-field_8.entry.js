import { r as registerInstance, c as createEvent, h, d as getAssetPath, g as getElement, F as Fragment, H as Host } from './index-3fb28577.js';
import { n as navStateStore, E as EventActions, k as DEALER_SEARCH_DISPLAY_ELEMENT_ID, s as splitLocale, a as navContentStore, f as ElementTypes, l as DEALER_SEARCH_RESULT_DISPLAY_ELEMENT_ID_DOUBLE_DRAWER, C as ClickElementTypes, m as DEALER_SEARCH_TARGET_ELEMENT } from './nav-content-store-ad934a75.js';
import { i as isString, b as getConfig, O as getHTMLInputElement, J as MenuItemVariant, P as addQueryParamsToUrl, n as isDesktop, Q as getErrorMessage, R as DEALER_MARKET_SEARCH_TERM, T as GEOLOCATION_BUTTON_SEARCH_TERM, N as NaviError, a as NaviErrorTypes, g as getString, u as getHTMLElement } from './navi-error-d2e07707.js';
import { d as dealerSearchResultsStore } from './ab-testing-constructor-service-ac142693.js';
import { c as getDealerDetailsRoutingKey, a as RoutingKeys } from './routing-key-12b2ffae.js';
...
import { g as getOpeningHours, a as sanitizeDealerHomepage, b as getRegionSpecificCountry } from './dealer-search-helper-c1c03ec9.js';
import { f as featureToggles, l as logger } from './feature-toggles-1274e59b.js';
import { b as getAllPPNDealersForMarket, c as getPPNDealersByRegion, d as getPPNDealers } from './dealer-service-884b3c09.js';
import { w as windowService } from './window-service-890948e7.js';
import { s as sendDataLayerEvent } from './data-layer-event-sender-2a4d9808.js';
...
function ErrorMessage({ errorMessage, onDismiss }) {
  return (h("div", { class: "error-message animated" },
    h("phn-p-inline-notification", { state: "error", description: errorMessage, onDismiss: onDismiss })));
}
...
function DealerSearchFormItemCard({ dealer, showOverlay, eventEmitter, locale }) {
  ...
  return (h("phn-menu-item-card", { tabIndex: 0, text: name, class: `animated ${showOverlay ? 'dealer-card-overlay' : ''} dealer-card`, onClick: () => onDealerCardClick(ppnDealer), analyticsId: ppnDealer.id },
    h("div", { class: "phn-flex-row phn-justify-between phn-align-center" },
      country === 'JP' ? (h("phn-p-text", { color: "primary", size: "small" }, `〒${ppnDealer.address.postalCode} ${address.city} ${address.street}`)) : (h("phn-p-text", { color: "primary", size: "small" },
        `${address.street}, `,
        h("span", { class: "city" },
...
const MenuItemCard = class {
  ...
  renderTitle() {
    return (h("div", { class: "phn-flex-row phn-align-center phn-justify-between title-container" }, h("phn-p-heading", { tag: "h3", size: "medium" }, this.text), isString(this.iconLeft) ? h("phn-p-icon", { name: this.iconLeft }) : null));
  }
  renderSubtitle() {
