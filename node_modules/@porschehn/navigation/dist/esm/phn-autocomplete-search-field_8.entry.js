import { r as registerInstance, c as createEvent, h, d as getAssetPath, g as getElement, F as Fragment, H as Host } from './index-192f2625.js';
import { n as navStateStore, E as EventActions, l as DEALER_SEARCH_DISPLAY_ELEMENT_ID, s as splitLocale, b as navContentStore, m as getErrorMessage, h as ElementTypes, o as DEALER_SEARCH_RESULT_DISPLAY_ELEMENT_ID_DOUBLE_DRAWER, N as NaviError, a as NaviErrorTypes, C as ClickElementTypes, p as DEALER_SEARCH_TARGET_ELEMENT } from './nav-content-store-0a34ed51.js';
import { i as isString, a as getConfig, J as getHTMLInputElement, G as MenuItemVariant, K as addQueryParamsToUrl, l as isDesktop, O as DEALER_MARKET_SEARCH_TERM, P as GEOLOCATION_BUTTON_SEARCH_TERM, g as getString, r as getHTMLElement } from './helper-baaa661e.js';
import { d as dealerSearchResultsStore } from './ab-testing-constructor-service-a7d54c98.js';
import { c as getDealerDetailsRoutingKey, a as RoutingKeys } from './routing-key-43812601.js';
import { g as globalDataLayerService } from './global-data-layer-service-04808730.js';
import { c as componentsOnReady } from './ready-c68c84a9.js';
import { T as Timeout } from './timeout-aa680917.js';
import { a as analyticsManager } from './analytics-manager-0d4961b8.js';
import { g as getOpeningHours, a as sanitizeDealerHomepage, b as getRegionSpecificCountry } from './dealer-search-helper-da8fe90b.js';
import { f as featureToggles, l as logger, w as windowService } from './feature-toggles-007debe5.js';
import { b as getAllPPNDealersForMarket, c as getPPNDealersByRegion, d as getPPNDealers } from './dealer-service-ad95dc2e.js';
import { s as sendDataLayerEvent } from './data-layer-event-sender-def87579.js';
import './router-store-a2dec16d.js';
import './menu-items-service-7741c024.js';
