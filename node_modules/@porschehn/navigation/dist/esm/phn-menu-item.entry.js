...
import { E as EventActions, C as ClickElementTypes } from './nav-content-store-0a34ed51.js';
import { i as isString } from './helper-baaa661e.js';
import { s as sendDataLayerEvent } from './data-layer-event-sender-def87579.js';
import './global-data-layer-service-04808730.js';
import './analytics-manager-0d4961b8.js';
...
function MenuItemText({ text, size, subtext, fontWeight }) {
  return (h("div", { class: "skeleton-item" },
    h("phn-p-text", { size: size, color: "inherit", tag: "div", weight: fontWeight }, text),
    isString(subtext) ? (h("div", { class: "text-limit" },
      h("phn-p-text", { class: 'subtext', color: 'inherit', weight: "regular", size: "x-small", tag: "div", ellipsis: "true", "data-test-id": "subtext" }, subtext))) : null));
}

function Icon({ isLoading, icon }) {
  if (isLoading) {
    return (h("div", { class: "icon-container" },
      h("phn-p-spinner", { color: "inherit", size: "inherit" })));
  }
  if (isString(icon)) {
    return (h("div", { class: "icon-container skeleton-item" },
      h("phn-p-icon", { color: "inherit", size: "inherit", source: icon }),
      h("slot", { name: "icon-modifier" })));
  }
  return null;
}
...
export { MenuItem as phn_menu_item };
