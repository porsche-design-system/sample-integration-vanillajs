import { r as registerInstance, h, H as Host, F as Fragment } from './index-192f2625.js';
import { g as globalDataLayerService } from './global-data-layer-service-dc914682.js';
import { E as EventActions, C as ClickElementTypes, h as ElementTypes } from './nav-content-store-238e6137.js';
import { a as analyticsManager } from './analytics-manager-8f2e83f9.js';
import { g as getCurrentRoute } from './routing-manager-2bba85b2.js';
import { i as isString, O as isModelFuelTypeGasoline } from './helper-76937d0b.js';
import './routing-key-808e9d26.js';
...
const BackButton = class {
  ...
  render() {
    return (h(Host, null, h("phn-p-button-pure", { size: "inherit", icon: "arrow-head-left", class: "back-button-text-link", aria: { 'aria-label': 'Back to Menu' }, onClick: () => this.sendDataLayerEvent() }, this.text)));
  }
};
...
const Heading = class {
  ...
  render() {
    return (h(Host, null, h("phn-p-heading", { size: "inherit" }, this.text), isString(this.subtext) ? (h("div", { class: "text-limit" }, h("phn-p-text", { color: "contrast-high", size: "xx-small", tag: "div", ellipsis: "true" }, this.subtext))) : null));
  }
};
...
export { BackButton as phn_back_button, Heading as phn_heading, SignatureHeading as phn_signature_heading };
