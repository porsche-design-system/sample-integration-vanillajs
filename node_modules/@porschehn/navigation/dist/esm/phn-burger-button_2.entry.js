import { r as registerInstance, h, H as Host } from './index-192f2625.js';
import { g as globalDataLayerService } from './global-data-layer-service-dc914682.js';
import { E as EventActions, C as ClickElementTypes, b as navContentStore, n as navStateStore } from './nav-content-store-238e6137.js';
import { N as NavigationTheme, f as NavigationMode, H as getRightTheme, p as constructThemeClass, I as IsLoggedIn } from './helper-76937d0b.js';
...
const MyPorscheIconButton = class {
  ...
  render() {
    ...
    return (h(Host, null, h("phn-p-button-pure", { icon: `user${isLoggedIn ? '-filled' : ''}`, "hide-label": "true", stretch: "true", "data-id": `${RoutingKeys.MY_PORSCHE}-contextual-button`, aria: "{ 'aria-haspopup': 'dialog', 'aria-label' : 'open the my porsche menu' }", "data-test-id": "myporsche-button", theme: getRightTheme(this.theme, this.mode), onMouseEnter: () => {
      ...
      } }), unreadMessagesCount > 0 ? (h("span", { class: `myporsche-unread-messages-indicator ${getRightTheme(this.theme, this.mode)}` })) : null));
  }
};
MyPorscheIconButton.style = myPorscheIconButtonCss;

export { BurgerButton as phn_burger_button, MyPorscheIconButton as phn_my_porsche_icon_button };
