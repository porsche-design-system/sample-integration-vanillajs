...
import { addQueryParamsToUrl, buildRoutingKeyHistoryFromContentPath, constructThemeClass, getRightTheme, getRootMenuItem, getValidContentPathSegments, sanitizeApp } from "../helper";
...
describe('helper', () => {
  ...
  describe('sanitize app', () => {
    it('should return default app', () => {
      const app = sanitizeApp('any other app');
      expect(app).toEqual('default');
    });
    it('should return shop app', () => {
      const app = sanitizeApp('shop');
      expect(app).toEqual('shop');
    });
    it('should return pcom app', () => {
      const app = sanitizeApp('pcom');
      expect(app).toEqual('pcom');
    });
  });
});
