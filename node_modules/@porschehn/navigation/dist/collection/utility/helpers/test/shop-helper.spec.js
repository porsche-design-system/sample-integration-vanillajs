...
import { filterWishlistItemsByAuthStatus, getAvailableShopVariables, getIconNameByMenuItemId, handleFilledIcon, isShopAvailable, isShopAvailableAndLogoLinksToShop, loadsShopPropsOnStore, modifyShopItemDependingOnMarket } from "../shop-helper";
describe('shop helper', () => {
  ...
  it('should return not filled icon for numberOfItems <= 0', () => {
    const iconZero = handleFilledIcon('shopping-bag', 0);
    const iconNegativeValue = handleFilledIcon('shopping-bag', -1);
    expect(iconZero).toEqual('shopping-bag');
    expect(iconNegativeValue).toEqual('shopping-bag');
  });
  it('should return filled icon for numberOfItems > 0', () => {
    const iconPositiveValue = handleFilledIcon('shopping-bag', 1);
    expect(iconPositiveValue).toEqual('shopping-bag-filled');
  });
