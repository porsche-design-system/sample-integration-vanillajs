...
export function isShopAvailable(locale, app) {
  var _a;
...
export function isShopAvailableAndLogoLinksToShop(locale, app, shop) {
  return isShopAvailable(locale, app) && logoLinksToShop(locale) && shop !== null;
}
export function modifyShopItemDependingOnMarket(locale, app, content) {
...
export function filterWishlistItemsByAuthStatus(menuItems, authStatusList) {
...
export function getAvailableShopVariables() {
...
export function loadsShopPropsOnStore(props) {
...
export function getIconNameByMenuItemId(id) {
