...
import { EventActions, IFRAME_ID, NavigationMode, NavigationTheme, VERSION } from "../../utility/constants";
...
export class Header {
  ...
  static get watchers() {
    return [{
        ...
        "propName": "numberOfShoppingItems",
        "methodName": "watchShopVariables"
      }, {
        "propName": "wishlistItemsNumber",
        "methodName": "watchShopVariables"
      }, {
