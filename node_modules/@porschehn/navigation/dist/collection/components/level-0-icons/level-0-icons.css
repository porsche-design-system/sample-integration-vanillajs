...
.contextual-icons div.left-icons,
.contextual-icons div.right-icons {
  display: flex;
  flex-direction: row;
  align-items: center;
}
...
.contextual-icons .icon-flex {
  display: flex;
  justify-content: center;
}
.contextual-icons div.icon {
  position: relative;
  padding: 0.375rem;
}
.contextual-icons div.icon .shopping-cart-link {
  position: relative;
  z-index: 2;
}
.contextual-icons div.icon .shopping-item-count {
  color: white;
  position: absolute;
  margin-left: 17px;
  margin-top: -6px;
...
.contextual-icons div.icon .shopping-item-count.pill {
  margin-left: 23px;
  font-size: 10px;
  width: 20px;
  height: 7px;
}
.contextual-icons div.icon .shopping-item-count.light {
  background-color: #2762ec;
}
.contextual-icons div.icon .shopping-item-count.dark {
...
.skeleton-container .burger-button-skeleton {
...
.skeleton-container .pure-button-skeleton {
  width: 1.5rem;
  height: 1.5rem;
  border-radius: 4px;
  background: #d8d8db;
