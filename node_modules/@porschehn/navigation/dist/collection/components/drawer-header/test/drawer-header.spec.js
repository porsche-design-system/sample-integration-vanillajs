...
describe('Drawer Header', () => {
  ...
  describe('snapshot tests', () => {
    describe('mobile snapshot tests', () => {
      it('hides heading & backButton in level1 menu', async () => {
        const page = await newSpecPage({
          ...
          template: () => (h("phn-drawer-header", { backButtonAnalyticsId: "menu", activeRoutingKey: "mainmenu", breakpoint: breakpoint.xs, receivedContent: true }))
        });
      ...
      it('shows models heading text in models overview', async () => {
        ...
        const page = await newSpecPage({
          components: [DrawerHeader],
          template: () => (h("phn-drawer-header", { showBackButton: true, backButtonAnalyticsId: "menu", activeRoutingKey: "models", breakpoint: breakpoint.xs, receivedContent: true }))
        });
        expect(page.root).toMatchInlineSnapshot(`
          <phn-drawer-header>
            <div class="drawer-header">
              <phn-back-button activeroutingkey="models" analyticsid="menu" class="back-button" text=""></phn-back-button>
      ...
      it('model signature of 911 is shown for the 911 model', async () => {
        ...
        const page = await newSpecPage({
          components: [DrawerHeader],
          template: () => (h("phn-drawer-header", { showBackButton: true, backButtonAnalyticsId: "menu", activeRoutingKey: "models/mainmenu.911", breakpoint: breakpoint.xs, receivedContent: true }))
        });
        expect(page.root).toMatchInlineSnapshot(`
          <phn-drawer-header>
            <div class="drawer-header">
              <phn-back-button activeroutingkey="models/mainmenu.911" analyticsid="menu" class="back-button" text=""></phn-back-button>
      ...
      it('displays skeleton for the close button', async () => {
        const page = await newSpecPage({
          components: [DrawerHeader],
          template: () => (h("phn-drawer-header", { backButtonAnalyticsId: "menu", activeRoutingKey: "mainmenu", breakpoint: breakpoint.xs, receivedContent: false }))
        });
        expect(page.root).toMatchInlineSnapshot(`
          <phn-drawer-header>
            <div class="drawer-header">
      ...
      it('displays skeleton for models menu drawer header, back & close button', async () => {
        ...
        const page = await newSpecPage({
          components: [DrawerHeader],
          template: () => (h("phn-drawer-header", { showBackButton: true, backButtonAnalyticsId: "menu", activeRoutingKey: "models", breakpoint: breakpoint.xs, receivedContent: false }))
        });
        expect(page.root).toMatchInlineSnapshot(`
          <phn-drawer-header>
            <div class="drawer-header">
              <phn-back-button activeroutingkey="models" analyticsid="menu" class="back-button" text="" style="display: none;"></phn-back-button>
              <div class="button-skeleton"></div>
      ...
      it('displays skeleton for model-signature, back & close button', async () => {
        ...
        const page = await newSpecPage({
          components: [DrawerHeader],
          template: () => (h("phn-drawer-header", { showBackButton: true, backButtonAnalyticsId: "menu", activeRoutingKey: "models/mainmenu.911", breakpoint: breakpoint.xs, receivedContent: false }))
        });
        expect(page.root).toMatchInlineSnapshot(`
          <phn-drawer-header>
            <div class="drawer-header">
              <phn-back-button activeroutingkey="models/mainmenu.911" analyticsid="menu" class="back-button" text="" style="display: none;"></phn-back-button>
              <div class="button-skeleton"></div>
              <div class="skeleton-headline"></div>
              <phn-signature-heading subtext="Gasoline" text="911"></phn-signature-heading>
              <phn-p-button-pure class="close-button" data-test-id="close-button" hidelabel="true" icon="close" size="small" style="display: none;">
    ...
    describe('desktop snapshot tests', () => {
      it('hides back button when showBackButton prop not passed', async () => {
        const page = await newSpecPage({
          components: [DrawerHeader],
          template: () => (h("phn-drawer-header", { backButtonAnalyticsId: "menu", activeRoutingKey: "mainmenu", breakpoint: 0, receivedContent: true }))
        });
        expect(page.root).toMatchInlineSnapshot(`
          <phn-drawer-header>
            <div class="drawer-header">
      ...
      it('uses default text for back button when backButtonText prop not passed', async () => {
        const page = await newSpecPage({
          components: [DrawerHeader],
          template: () => (h("phn-drawer-header", { showBackButton: true, backButtonAnalyticsId: "menu", activeRoutingKey: "mainmenu", breakpoint: 0, receivedContent: true }))
        });
        expect(page.root).toMatchInlineSnapshot(`
          <phn-drawer-header>
            <div class="drawer-header">
              <phn-back-button activeroutingkey="mainmenu" analyticsid="menu" class="back-button" text=""></phn-back-button>
              <phn-heading class="heading-items" subtext="" text="" style="display: none;"></phn-heading>
              <phn-p-button-pure class="close-button" data-test-id="close-button" hidelabel="true" icon="close" size="small">
                Close Dialog
              </phn-p-button-pure>
      ...
      it('uses custom text for back button when backButtonText prop is passed', async () => {
        const page = await newSpecPage({
          components: [DrawerHeader],
          template: () => (h("phn-drawer-header", { showBackButton: true, backButtonText: "Back", backButtonAnalyticsId: "menu", activeRoutingKey: "series/mainmenu.718", breakpoint: 0, receivedContent: true }))
        });
        expect(page.root).toMatchInlineSnapshot(`
          <phn-drawer-header>
            <div class="drawer-header">
              <phn-back-button activeroutingkey="series/mainmenu.718" analyticsid="menu" class="back-button" text=""></phn-back-button>
              <phn-heading class="heading-items" subtext="" text="" style="display: none;"></phn-heading>
              <phn-p-button-pure class="close-button" data-test-id="close-button" hidelabel="true" icon="close" size="small">
                Close Dialog
              </phn-p-button-pure>
  ...
  describe('button is clicked', () => {
    it('emits clickDrawerHeaderBack event when back button is clicked', async () => {
      var _a;
      const page = await newSpecPage({
        components: [DrawerHeader],
        template: () => (h("phn-drawer-header", { showBackButton: true, backButtonAnalyticsId: "menu", activeRoutingKey: "series/mainmenu.718", breakpoint: 0 }))
      });
      routerStore.state.routingKeyHistory = ['mainmenu', 'series', 'series/mainmenu.718'];
      routerStore.state.routingKeyPointer = 2;
      page.rootInstance.clickDrawerHeaderBack.emit = jest.fn();
      el.mouseClick(getHTMLElement((_a = page.root) === null || _a === void 0 ? void 0 : _a.querySelector('phn-back-button')));
      expect(page.rootInstance.clickDrawerHeaderBack.emit).toHaveBeenCalled();
    });
    it('emits clickDrawerHeaderClose event when close button is clicked', async () => {
      var _a;
      const page = await newSpecPage({
        components: [DrawerHeader],
        template: () => (h("phn-drawer-header", { backButtonAnalyticsId: "menu", activeRoutingKey: "series/mainmenu.718", breakpoint: 0 }))
      });
  ...
  describe('mobile headings', () => {
    it('displays drawer header without heading', async () => {
      ...
      const page = await newSpecPage({
        components: [DrawerHeader],
        template: () => (h("phn-drawer-header", { backButtonAnalyticsId: "menu", activeRoutingKey: "mainmenu", breakpoint: breakpoint.xs }))
      });
    ...
    it('displays models drawer header with heading', async () => {
      ...
      const page = await newSpecPage({
        components: [DrawerHeader],
        template: () => (h("phn-drawer-header", { showBackButton: true, backButtonAnalyticsId: "menu", activeRoutingKey: "models", breakpoint: breakpoint.xs }))
      });
    ...
    it('displays signature-heading for 911', async () => {
      ...
      const page = await newSpecPage({
        components: [DrawerHeader],
        template: () => (h("phn-drawer-header", { showBackButton: true, backButtonAnalyticsId: "menu", activeRoutingKey: "models/mainmenu.911", breakpoint: breakpoint.xs }))
      });
