...
export default function ShopSection({ activeRoutingKey, breakpoint, receivedContent, loginEvent }) {
  ...
  return (h(Fragment, null, h("phn-menu", { item: displayedContent, routingKey: activeRoutingKey, showHeadline: showHeadline, receivedContent: receivedContent }), activeRoutingKey === RoutingKeys.SHOP ? (h("div", { class: "wishlist-container", role: "list" }, wishListItems.map((childItem) => {
