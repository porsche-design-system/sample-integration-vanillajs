...
import { constructRoutingKey, getDealerDetailsRoutingKey, getModelsRoutingKey, getSeriesRoutingKey, RoutingKeys } from "../../../entities/routing-key";
  ...
  describe('snapshot tests', () => {
    ...
    it('should move backwards from 911 to models when back button is clicked', async () => {
      const page = await newSpecPage({
        components: [DoubleDrawer],
        template: () => (h("phn-double-drawer", Object.assign({}, defaultProps, { routingKeyPointer: 2, routingKeyHistory: [RoutingKeys.MAIN_MENU, RoutingKeys.MODELS, getSeriesRoutingKey('mainmenu.911')] })))
      });
      if (page.root)
        animationManager.initialize(page.root);
