...
export const registerOpenSingleDrawerAnimation = ({ onAnimationStarts, onAnimationEnds }) => {
  const sequence = [
    [
      {
...
export const registerCloseSingleDrawerAnimation = ({ onAnimationStarts, onAnimationEnds }) => {
  const sequence = [
    [
      {
        onStart: onAnimationStarts,
...
export const registerTransitionNextLevelSingleDrawerAnimation = ({ onAnimationEnds }) => {
...
export const registerTransitionPreviousLevelSingleDrawerAnimation = ({ onAnimationEnds }) => {
...
//# sourceMappingURL=single-drawer-animation-sequences.js.map
