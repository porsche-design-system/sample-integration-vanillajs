...
describe('phn-car-body-types-drawer', () => {
  ...
  beforeEach(async () => {
    page = await newSpecPage({
      ...
      template: () => (h("phn-car-body-types-drawer", { series: mockSeriesContent, breakpoint: breakpoint.s, activeRoutingKey: "models/mainmenu.911" }))
    });
  ...
  describe('skeleton', () => {
    it('should render skeleton when images are not loaded yet', async () => {
      ...
      page = await newSpecPage({
        components: [CarBodyTypeDrawer],
        template: () => (h("phn-car-body-types-drawer", { series: mockSeriesContent, breakpoint: breakpoint.s, activeRoutingKey: "mainmenu" }))
      });
