...
describe('myporsche-drawer', () => {
  ...
  describe('mobile', () => {
    describe('logged out user', () => {
      ...
      it('should not show saved Search and Vehicles if feature toggle is not available', async () => {
        var _a, _b;
        jest.spyOn(featureToggles, 'isSavedItemsToggleActive').mockReturnValue(false);
        const page = await getPage();
