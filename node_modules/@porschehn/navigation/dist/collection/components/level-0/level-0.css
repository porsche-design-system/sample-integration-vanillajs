...
@media (min-width: 1920px) {
  :host header.limited-width {
    padding: 0 calc(50vw - 2560px);
  }
}
:host header {
  margin: 0;
...
:host header .level-0-content .level-0-content-logo {
  display: flex;
  align-items: center;
}
:host header .level-0-content .level-0-content-icons {
  position: absolute;
  width: 100%;
}
:host header .level-0-content phn-burger-button,
:host header .level-0-content phn-level-0-icons,
:host header .level-0-content phn-logo,
:host header .level-0-content .skeleton-container {
  flex: 1;
  display: flex;
}
:host header .level-0-content .skeleton-container.crest-skeleton {
...
:host header .level-0-content .burger-button-skeleton {
  width: 1.5rem;
  height: 1.5rem;
...
:host header .level-0-content .label-bone {
  width: 7.75rem;
  height: 1.5rem;
  border-radius: 0.25rem;
...
:host header .level-0-content .crest-bone {
  width: 1.403125rem;
  height: 1.8125rem;
...
@media (min-width: 760px) {
  :host header phn-burger-button {
    padding: 1.75rem 0 1.5rem 1.25rem;
  }
}
@media (min-width: 1000px) {
  :host header phn-burger-button {
...
:host header .burger-button:focus {
  outline-width: 2px;
  outline-style: solid;
  outline-offset: 1px;
  outline-color: #1a44ea;
}
:host .main-content {
  width: 1.25rem;
}
